...
//  exercise
//
//  Created by Nurjol Badyelkhan on 2021/05/03.
//
...
int next2[10] = {5,2,3,4,8,6,7,8,9,0};
...
int main()
{
    ...
    while(1){
        ...
        pos += previous;
        i = pos ;
        if(i<=N) printf("pattern matching position: %d  \n",pos);
        else break;
        previous = i;
    }
    printf("pattern matching ended\n");
    printf("Nurjol 12190180\n");
    return 0;
}
